    ...
    <div class="flex-col w-full md:flex md:flex-row md:min-h-screen">
        <div @click.away="open = false"
            ...
            <div class="flex flex-row items-center justify-between flex-shrink-0 px-8 py-4">
                <a href="#"
                    class="text-lg font-semibold tracking-widest text-gray-900 uppercase rounded-lg dark:text-white focus:outline-none focus:shadow-outline">PATNIZO HOTELS
                    </a>
            ...
            <nav :class="{'block': open, 'hidden': !open}"
                ...
                <x-admin-link :href="route('customers.index')"
                    :active="request()->routeIs('customers.index')">Our Customers
                </x-admin-link>
                <x-admin-link :href="route('payment.index')"
                    :active="request()->routeIs('payment.index')">payments
                </x-admin-link>

                <x-admin-link :href="route('booking.index')"
                    :active="request()->routeIs('booking.index')">Bookings
                </x-admin-link>

                <x-admin-link :href="route('tour.index')"
                    :active="request()->routeIs('tour.index')">TourServices
                </x-admin-link>
                <x-admin-link :href="route('comment.index')"
                    :active="request()->routeIs('comment.index')">Comments
                </x-admin-link>
